...
public class UserServiceBffController {
    ...
    public ResponseEntity<?> changeUser(@RequestBody User user) {
        String url = "http://localhost:8081/api/v1/take_a_guide/user/change";
    ...
    public ResponseEntity<?> retrieveUsers(@RequestBody User user) {
        String url = "http://localhost:8081/api/v1/take_a_guide/user/retrieve";
    ...
    public ResponseEntity<?> createUser(@RequestBody User user) {
        String url = "http://localhost:8081/api/v1/take_a_guide/user/create";
        ResponseEntity<?> response = restTemplate.postForEntity(url, user, Object.class);
        return response;
    }
    ...
    public ResponseEntity<?> removeUser(@RequestBody User user) {
        String url = "http://localhost:8081/api/v1/take_a_guide/user/remove";
    ...
    public ResponseEntity<?> loginUser(@RequestBody LoginRequest request) {
        String url = "http://localhost:8081/api/v1/take_a_guide/user/login";
